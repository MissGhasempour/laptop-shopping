    ...
    <div>
      <div>
        <ul
          ...
          className="sm:text-sm max-md:w-190 lg:text-2xl max-sm:text-sm 2xl:w-785  max-2xl:w-331 2xl:text-6xl md:w-331 md:text-xl  lg:w-252  max-sm:w-116 sm:w-167 max-xl:xl:w-full ">
