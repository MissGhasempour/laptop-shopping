...
export default function BestProduct({
  ...
  return (
    <div className="border rounded-2xl m-2 bg-stone-100">
      <div>
        ...
        <div className="my-6">
          {index === 0 ? (<Image src={img1} alt="laptop-pic" className=" sm:w-100 max-sm:w-40"/>) : index === 1 ? (<Image src={img2} alt="laptop-pic" className="sm:w-95 max-sm:w-34"/>) : (<Image src={img3} alt="laptop-pix" className="sm:w-102 max-sm:w-34" />)}
        </div>
