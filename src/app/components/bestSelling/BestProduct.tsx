...
export default function BestProduct({
  ...
  return (
    <div>
      <div>
        <div className="relative left-70 top-5">
        ...
        <div className="mx-5">
          ...
          <div className="relative left-42">
            ...
            <h2 className="inline-block ml-3">4.5</h2>
          </div>
        </div>
        <div>
          {index === 0 ? (
            <Image src={img1} alt="laptop-pic" className="w-100" />
          ) : index === 1 ? (
            <Image src={img2} alt="laptop-pic" className="w-83" />
          ) : (
        ...
        <p className="ml-2 text-blue-500">{res[index].aliases} </p>
        <button
          onClick={shop}
          className="bg-stone-800 w-50 rounded-xl text-zinc-100 py-2 my-7 mx-10"
        >
          Shop
        </button>
      </div>
